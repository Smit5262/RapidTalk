...
-- CreateEnum
CREATE TYPE "ChannelType" AS ENUM ('PUBLIC', 'PRIVATE', 'DIRECT_MESSAGE', 'GROUP_DM');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MENTION', 'DIRECT_MESSAGE', 'WORKSPACE_INVITE', 'CHANNEL_ACTIVITY', 'AI_DIGEST', 'SYSTEM');
...
-- CreateIndex
CREATE UNIQUE INDEX "ChannelMember_channelId_workspaceMemberId_key" ON "ChannelMember"("channelId", "workspaceMemberId");
...
-- CreateIndex
CREATE INDEX "AiLog_workspaceId_createdAt_idx" ON "AiLog"("workspaceId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "AiLog" ADD CONSTRAINT "AiLog_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;
